 ...
 *
 */
public class OpenStreetMapNodesBulkLoadDriver extends Configured implements Tool 
{
	...
	private static final String COLUMN_FAMILY_1="nodeData";
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			int response = ToolRunner.run(HBaseConfiguration.create(),
				new OpenStreetMapNodesBulkLoadDriver(), args);
...
//		configuration.set("COLUMN_FAMILY_2",COLUMN_FAMILY_2);
		...
		job.setJarByClass(OpenStreetMapNodesBulkLoadDriver.class);
		
		job.setInputFormatClass(TextInputFormat.class);
		
		job.setMapOutputKeyClass(ImmutableBytesWritable.class);
		
		job.setMapperClass(OpenStreetNodesMapper.class);
